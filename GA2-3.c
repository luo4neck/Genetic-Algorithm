...
if ( year1>year2 && p->AL[0]==0)// not confess is better
  { p->std[j] = p->std[j] - 0.05; }
  
else if ( year1>year2 && p->AL[0]==1)// confess is better
  { p->std[j] = p->std[j] + 0.05; }
  
else if ( year1<year2 && p->AL[2]==0)// not confess is better
  { p->std[j] = p->std[j] - 0.05; }
  
else if ( year1<year2 && p->AL[2]==1)// confess is better
  { p->std[j] = p->std[j] + 0.05; }
  
//printf("%d%d%d%d  %d %d %d %f\n",p->AL[0],p->AL[1],p->AL[2],p->AL[3], year1, year2,i,p->std[i]);
}
